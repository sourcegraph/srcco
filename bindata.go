...
func data_publish_gh_pages_sh() (*asset, error) {
	...
	info := bindata_file_info{name: "data/publish-gh-pages.sh", size: 4322, mode: os.FileMode(420), modTime: time.Unix(1424859278, 0)}
...
func data_srcco_css() (*asset, error) {
	...
	info := bindata_file_info{name: "data/srcco.css", size: 3423, mode: os.FileMode(420), modTime: time.Unix(1424859274, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func data_srcco_js() (*asset, error) {
	...
	info := bindata_file_info{name: "data/srcco.js", size: 1554, mode: os.FileMode(420), modTime: time.Unix(1424859274, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func data_view_html() (*asset, error) {
	...
	info := bindata_file_info{name: "data/view.html", size: 787, mode: os.FileMode(420), modTime: time.Unix(1424859274, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
